    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (sub) {
            ...
            case "setlevel": {
                ...
                level = plugin.getApi().setLevel(target, skill, level, WastelandChangeReason.COMMAND);
            ...
            case "addxp": {
                ...
                long awarded = plugin.getApi().addXp(target, skill, amount, WastelandXpCause.COMMAND, "/wasteland addxp");
                sender.sendMessage(MessageUtil.getMessage(plugin, "admin.added-xp")
                        .replace("{player}", target.getName())
                        .replace("{skill}", skill.getKey())
                        .replace("{amount}", String.valueOf(awarded)));
                return true;
            }
            ...
            case "removexp": {
                ...
                plugin.getApi().removeXp(target, skill, amount, WastelandChangeReason.COMMAND);
            ...
            case "settier": {
                ...
                tier = plugin.getApi().setTier(target, tier, WastelandChangeReason.COMMAND);
            ...
            case "reset": {
                ...
                plugin.getApi().resetPlayer(target.getUniqueId(), WastelandChangeReason.COMMAND);
